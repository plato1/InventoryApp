...
public class StockProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        String price = values.getAsString(StockContract.StockEntry.COLUMN_ITEM_PRICE);
        if (price == null) {
        ...
        String sname = values.getAsString(StockContract.StockEntry.COLUMN_ITEM_SUPPLIER);
        if (sname == null) {
    ...
    private int updateStock(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(StockContract.StockEntry.COLUMN_ITEM_SUPPLIER)) {
            String name = values.getAsString(StockContract.StockEntry.COLUMN_ITEM_SUPPLIER);
            if (name == null) {
                throw new IllegalArgumentException("Item requires a supplier name");
            }
        }
